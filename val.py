...
if __name__ == '__main__':
    model_path = r"<PROJECT_ROOT>\runs\train\轻量化探索-cctsdb--yolo11-CSP-PMSFA-Lite-2\weights\best.pt"
    model = YOLO(model_path) # 选择训练好的权重路径
    
    result = model.val( data=r"%USERPROFILE%\Desktop\CCTSDB 2021\实验\cctsdb.yaml",
                        ...
                        project='runs/val',
                        name='nop5-轻量化探索-cctsdb--yolo11-CSP-PMSFA-Lite-NoP5'
                        )
