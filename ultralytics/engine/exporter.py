...
from ultralytics.nn.tasks import DetectionModel, SegmentationModel, WorldModel, DETECT_CLASS
...
class Exporter:
    ...
    def __call__(self, model=None) -> str:
        ...
        for m in model.modules():
            if isinstance(m, (Detect, RTDETRDecoder) + DETECT_CLASS):  # includes all Detect subclasses like Segment, Pose, OBB
