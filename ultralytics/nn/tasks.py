...
C3K2_CLASS = (C3k2_Faster, C3k2_ODConv, C3k2_Faster_EMA, C3k2_DBB, C3k2_DeepDBB, C3k2_WDBB, C3k2_CloAtt, C3k2_SCConv, C3k2_ScConv, C3k2_EMSC, C3k2_EMSCP, C3k2_KW, C3k2_DySnakeConv, C3k2_DCNv2, C3k2_DCNv3,
              ...
              C3k2_GroupMambaBlock, C3k2_MambaVision
              )
...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in ((
            ...
            LDConv, CSP_MSCB, C2f_SPPFEnhance, C2f_ASPP, C2f_MSConv, CSP_PMSFA, CSP_PMSFA_K333, CSP_PMSFA_K357, CSP_PMSFA_K579, RFAConv, RFCBAMConv, RFCAConv, CSP_FreqSpatial, MANet, MANet_FasterBlock, MANet_FasterCGLU, 
            MANet_Star, PSConv, RepHMS, CSP_MSCB_SC, LoGStem, GSConvE
            ...
            if m in ((
                ...
                CSPStage, SPDConv, RepBlock, CSP_EDLAN, RGCSPELAN, CSP_PTB, XSSBlock, CSP_MSCB, C2f_SPPFEnhance, C2f_ASPP, C2f_MSConv, CSP_PMSFA, CSP_PMSFA_K333, CSP_PMSFA_K357, CSP_PMSFA_K579, CSP_FreqSpatial, MANet,
